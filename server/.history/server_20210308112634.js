...
mongodb.insert('users', { username:'mlf', userid:'916',meals:[],alltags:[] })
...
app.post('/addmeal',(request,response)=>{
   ...
   mongodb.update('users',{username:username,userid:userid},{$addToset:{meals:{mealName,picUrl,tags,descriptions}}})
       .then((database) => {
